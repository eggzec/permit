...
def test_activation_code_generate_round_trips_uuid7():
    """
    Purpose:
        Verifies that `app.domain.activation.ActivationCode.generate` preserves a supplied UUIDv7 and emits a grouped 30-symbol activation code.
        This matters because activation codes are a public representation of the underlying UUIDv7 identity.
