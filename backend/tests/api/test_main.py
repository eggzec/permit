...
def test_api_router_includes_health_and_auth_routes() -> None:
    """
    Verifies that `app.api.main.api_router` includes the health and auth route
    trees expected by the public API. This matters because the main API router
    is the composition point for the endpoints clients depend on.
