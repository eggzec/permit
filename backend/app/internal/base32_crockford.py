...
def encode(
    ...
    Args:
        ...
        split_length: If specified, the string will be divided into clusters of
                      that size separated by hyphens (0 = no splitting)
...
def decode(
    ...
    Args:
        ...
        checksum: If True, the string is assumed to have a trailing check symbol
    ...
    Raises:
        ValueError: If checksum validation fails, if strict mode is enabled and
                    normalization is needed, or if the string contains invalid
                    characters
    """
